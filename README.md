...
2. On a Windows machine, start a Command prompt / Powershell (Press Win + R, type `cmd`, and press Enter). On a Mac, start a Terminal (Applications > Utilities > Terminal).
...
- Windows: please follow the instructions in [Setup-Windows.md](Setup-Windows.md)
- Mac: please follow the instructions in [Setup-Mac.md](Setup-Mac.md)  


### Free use of Ollama
This is the code allowing you to use Ollama on your local device:
